...
public class CustomerIMPL implements CustomerI {
	...
	public String applyForloan(LoanApplicationDTO loanDTO) {
		try {
			...
			List<LoanApplication> existing = lr.findByCustomerEmail(loanDTO.getEmail());
			if (!existing.isEmpty()) {
	...
	public void editProfileByEmail(String email, Customers updateCust) {
		Customers existingCustomer = cr.findByUserEmail(email)
	...
	@Override
	public List<LoanApplicationDetailsDTO> getLoanApplications(String email) {
		...
		for (LoanApplication loan : applications) {
			...
			dto.setEmail(loan.getCustomer().getEmail());
	...
	@Override
	public String deleteLoanApplication(String email) {
		List<LoanApplication> applications = lr.findByCustomerEmail(email);
